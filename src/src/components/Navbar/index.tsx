  ...
  (props, ref) => {
    ...
    return (
      ...
      >
        ...
        {leftContent && <IconButton size="lg" {...leftContent} className="text-white" />}
      </div> */}
        <div className="Navbar-main">
          {logo && <img className="Navbar-logo" src={logo} alt={title} />}
          <div className="Navbar-inner">
            {showTitle && <h2 className="Navbar-title text-white">{title}</h2>}
        ...
        <div className="Navbar-right">
          ...
          {leftContent && (
            <IconButton size="lg" {...leftContent} className="text-white" />
          )}
        </div>
      </header>
    );

...
import { eventBus } from "../../../demo/Chat";
...
export const Composer = React.forwardRef<ComposerHandle, ComposerProps>(
  (props, ref) => {
    const {
      ...
      wideBreakpoint,
      placeholder: oPlaceholder = "Vui lòng nhập...",
      recorder = {},
      onInputTypeChange,
      onFocus,
      onBlur,
    ...
    eventBus.on("emoji", (emoji) => {
      setEmojiIcon(emoji);
      // Thêm emoji vào vị trí hiện tại của con trỏ trong text
      if (inputRef.current) {
        ...
        // Đặt lại vị trí con trỏ sau khi thêm emoji
        setTimeout(() => {
      ...
      <>
        <div className="Composer">
          ...
          <Action
            ...
            aria-label={isInputText ? 'Chuyển sang nhập bằng giọng nói' : 'Chuyển sang nhập bằng bàn phím'}
          />
        )} */}
          <div className="Composer-inputWrap">
          ...
          {hasToolbar && (
            <Action
              ...
              aria-label={
                isAccessoryOpen ? "Đóng thanh công cụ" : "Mở rộng thanh công cụ"
              }
            />
          )}
          {(text || textOnce) && (

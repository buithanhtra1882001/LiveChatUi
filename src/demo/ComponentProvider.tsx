...
export default () => {
  return (
    <DemoPage>
      <DemoSection title="Tải cục bộ">
        <ComponentsProvider components={components}>
          <TestLocalComponent />
        </ComponentsProvider>
      </DemoSection>
      <DemoSection title="Tải không đồng bộ slot">
        <ComponentsProvider components={components}>
          <LazySlot />
        </ComponentsProvider>
      </DemoSection>
      <DemoSection title="Không tìm thấy code">
        <ComponentsProvider components={components}>
          <TestNotFoundCode />
        </ComponentsProvider>
      </DemoSection>
      <DemoSection title="Lỗi thành phần">
        <ComponentsProvider components={components}>
          <TestComponentHasError />
        </ComponentsProvider>
      </DemoSection>
      <DemoSection title="URL không đúng">
        <ComponentsProvider components={components}>
          <TestErrorUrl />
        </ComponentsProvider>
      </DemoSection>
      ...
      <DemoSection title="Decorator không đồng bộ">
        <ComponentsProvider components={components}>
          <TestAsyncDecorator />
        </ComponentsProvider>
      </DemoSection>

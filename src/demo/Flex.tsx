...
export default () => (
  <DemoPage>
    <DemoSection title="Bố cục lưới cơ bản">
      <Flex>
        <FlexItem>
          <p>1/2</p>
        </FlexItem>
    ...
    <DemoSection title="Bố cục phần trăm">
      <Flex>
    ...
    <DemoSection title="Bố cục Holy Grail">
    ...
    <DemoSection title="Bố cục linh hoạt">
      <FluidLayout n={8} />
      <FluidLayout n={9} />
      <FluidLayout n={10} />
    </DemoSection>
